CREATE TABLE public.invoice_and_invoice_entry
(
...
ALTER TABLE public.invoice_and_invoice_entry
...
ALTER TABLE public.invoice_and_invoice_entry OWNER to postgres;
